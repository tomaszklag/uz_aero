...
| `sessionAxis.test.ts` | osi czasu sesji (10): kolejność zdarzeń, adresy uuid, kołowanie mierzone DO startu, brak ołówka i plakietki wpisu ręcznego (issue #40), stopka (blok / czas lotu / starty), sesja bez pracy silnika |
