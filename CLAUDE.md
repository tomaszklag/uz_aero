...
**Analityka zużycia** (2026-08-05): domena `packages/domain/src/consumption/` (interwały paliwowe odczyt→odczyt, NNLS per faza, przelicznik MH na godzinę zegara z automatycznym rozpoznaniem obrotomierz/Hobbs) + `GET /admin/api/fleet/:id/consumption`. Reguła czytania strumienia poza listami: `docs/architektura-panelu-serwer.md` §7.7. Zostało: ekran A10a/A10b w panelu web, norma w aplikacji pilota (04/06/10) i rozcięcie lotu na fazy pionowe ze śladu GPS.
