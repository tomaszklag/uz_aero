/**
 * Ninerdeck (serwer) - obrona przed CSRF dla tras panelu (`docs/architektura-panelu-serwer.md` §8.3).
 *
 ...
 *
 * **każda mutacja `/admin/api/*` musi nieść nagłówek `X-Ninerdeck-Admin: 1`.**
 *
...
export const ADMIN_CSRF_HEADER = 'x-ninerdeck-admin';
