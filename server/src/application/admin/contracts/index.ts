/**
 * Ninerdeck (serwer) - barrel kontraktów panelu.
 *
 * Docelowo wskazuje na niego mapa `exports` w `server/package.json`
 * (`@ninerdeck/server/admin-contracts`, `docs/architektura-panelu-serwer.md` §1.5), przez
...
export type * from './bugReports.ts';
...
export type * from './organizations.ts';
