 ...
 *
 * Ekran renderujemy CAŁY — z prawdziwym `PulpitScreen`, prawdziwym `useDashboard`
...
import { PulpitScreen } from '../src/screens/pulpit/PulpitScreen';
...
function render(data: DashboardDto | null): string {
  ...
  return renderToStaticMarkup(
    createElement(
      QueryClientProvider,
      { client },
      createElement(MemoryRouter, { initialEntries: ['/pulpit'] }, createElement(PulpitScreen)),
    ),
  );
}
