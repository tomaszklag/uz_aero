...
export type QuietVerdict = 'expected' | 'suspicious' | 'unknown';
...
export function quietView(data: DashboardDto): QuietView {
  ...
  const reasons = quietReasons(data, nowMs, lastMs);
...
const LABEL: Record<QuietVerdict, string> = {
