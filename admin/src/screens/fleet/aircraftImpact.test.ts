...
import { draftOf, type AircraftDraft } from './aircraftForm';
import { countChanges, impactCard } from './aircraftImpact';
...
const draft = (before: AircraftListItemDto, over: Partial<AircraftDraft> = {}): AircraftDraft => ({
  ...draftOf(before),
  ...over,
});
