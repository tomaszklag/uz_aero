 ...
 * pulpit nie.
 */
export function pulpitTiles(data: DashboardDto | null): PulpitTile[] {
 ...
 * ma alarmować.
 */
function exportTile(data: DashboardDto | null): PulpitTile {
