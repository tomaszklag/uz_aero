...
// wykrywać. Ten sam import robi już karta dnia (`DzienScreen`).
import { shortUuid } from '../flagi/flagRows';
import type { ExportScope } from './eksportyFilters';
import { EXPORT_STATE_META } from './eksportyStates';
 ...
 *
 * (Do 2026-08-01 proza tutaj, w `eksportyFilters.ts` i w kontrakcie serwera twierdziła,
