...
import { EKSPORTY_PAGE_LIMIT, type ExportScope } from './eksportyFilters';
 ...
 *
 * Do 2026-08-01 tego zdania na ekranie NIE BYŁO, choć docblock stałej `EKSPORTY_PAGE_LIMIT`
...
export function truncationNotice(page: {
  ...
  return (
    ...
    `${EKSPORTY_PAGE_LIMIT} wierszy naraz. Liczniki i kafle nad tabelą opisują CAŁY zakres, ` +
 ...
 */
export function eksportyEmpty(narrowed: boolean): EmptyCopy {
  return narrowed
    ? {
