...
export function formState(draft: KontoDraft): FormState {
...
export function createBody(draft: KontoDraft): CreatePilotBody {
  return {
...
export function draftOf(pilot: PilotListItemDto): KontoDraft {
  return {
    name: pilot.name,
    code: pilot.code,
    email: pilot.email ?? '',
 ...
 */
export function updateBody(before: PilotListItemDto, draft: KontoDraft): UpdatePilotBody {
...
export function hasChanges(before: PilotListItemDto, draft: KontoDraft): boolean {
