...
export interface DayPages {
   ...
   *
   * Bliźniaczy `screens/audit/auditPages.ts` niesie `null` z DWÓCH powodów, bo serwer
 ...
 */
export function daysEmpty(narrowed: boolean): DaysEmpty {
  if (narrowed) {
    return {
