...
export function formState(draft: SamolotDraft): FormState {
...
export const EMPTY_DRAFT: SamolotDraft = {
  reg: '',
  type: '',
  year: '',
  capacity: '',
...
export function draftOf(aircraft: AircraftListItemDto): SamolotDraft {
  return {
    reg: aircraft.reg,
    type: aircraft.type,
...
export function createBody(draft: SamolotDraft): CreateAircraftBody {
  return {
...
export function hasChanges(before: AircraftListItemDto, draft: SamolotDraft): boolean {
