...
import { MH_FORMAT_OPTIONS, parseCapacity, type SamolotDraft } from './samolotForm';
...
export function countChanges(before: AircraftListItemDto, draft: SamolotDraft): number {
...
function capacityRow(before: AircraftListItemDto, draft: SamolotDraft): ImpactRow {
  const capacityL = parseCapacity(draft.capacity);
...
function mhFormatRow(before: AircraftListItemDto, draft: SamolotDraft): ImpactRow {
...
function exampleOf(before: AircraftListItemDto, draft: SamolotDraft): string | null {
...
function dualRow(before: AircraftListItemDto, draft: SamolotDraft): ImpactRow {
...
function serviceRow(before: AircraftListItemDto, draft: SamolotDraft): ImpactRow {
