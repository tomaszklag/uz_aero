 ...
 *
 * Bliźniak `screens/dni/dniPages.ts` i te same cztery reguły kursora — z jedną różnicą,
 ...
 */
export function audytEmpty(narrowed: boolean): AudytEmpty {
  if (narrowed) {
    return {
