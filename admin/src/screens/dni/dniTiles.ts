 ...
 *
 * Bliźniak `screens/audyt/audytTiles.ts`. Kafle z mockupu `A02` odpowiadają na pytanie,
 ...
 */
export function dniTiles(counts: DniCounts, narrowed: boolean): DniTile[] {
